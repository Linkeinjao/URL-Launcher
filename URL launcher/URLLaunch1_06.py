...
class WebLauncherApp:
    def __init__(self, master):
        ...
        text_label = tk.Label(master, text="Nethergear Task Application Version 1.11")
        text_label.grid(row=6, column=1, padx=0, pady=0, sticky="w")
        text_label = tk.Label(master, text="A simple Python task management application")
        ...
        text_label = tk.Label(master, text="App created on the 17th of February 2024")
        text_label.grid(row=9, column=1, padx=0, pady=0, sticky="w")
        text_label = tk.Label(master, text="Current version date is the 18th of February 2024")
